...
var ContextMenuOverlay = class extends PositionMixin(Overlay) {
  static get is() {
...
var ItemsMixin = (superClass) => class ItemsMixin extends superClass {
  ...
  __initMenu(root, menu) {
    if (!root.firstElementChild) {
      ...
      const openSubMenu = (e, itemElement = e.composedPath().find((e2) => e2.localName === "vaadin-context-menu-item")) => {
 ...
 */
//# sourceMappingURL=chunk-MFHI2QIN.js.map
