...
import stylesCss from 'themes/moneyflow/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_moneyflow_componentCss']) {
    
    document['_vaadintheme_moneyflow_componentCss'] = true;
  }
